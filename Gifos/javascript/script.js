...
const API_KEY = 'byQqYwenoAXSDMQSa4M7CN1inJEHTm5x';
...
getTrendingsGifs = async() => {
    const response = await fetch(`https://api.giphy.com/v1/gifs/trending?api_key=byQqYwenoAXSDMQSa4M7CN1inJEHTm5x&limit=12&rating=g`);
    const json = await response.json();
...
showTrendingsGifs = trendingsGifs => {
    for (let i = 0; i < 3; i++) {
        ...
        gif.addEventListener("click", () => {
            ...
            /* funionalidad de los botones en los GIFS*/
...
if (persistFavs !== null) {
    ...
    while (i < persistFavs.length) {
        ...
        gif.addEventListener("click", () => {
            ...
            /* funcionalidad de de los botones */
